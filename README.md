...
Relational Databases are the schema in which data is stored - SQL language used to query relational databases.

2. Why do tables need a `primary key`?

Because tables must have a unique identifier for each row.
...
A third table, which you might call a Junction Table.
